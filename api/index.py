...
# Vercel বিল্ড ফ্রেন্ডলি ১০০% নিরাপদ এইচটিএমএল ব্লক
HTML_PAGE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', system-ui, sans-serif; }
        ...
        .management-box { background: white; border-radius: 24px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.02); text-align: left; border: 1px solid #f1f5f9; margin-top: 20px; }
...
<body>
    ...
    <div class="workspace-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stats-card">
                <p class="stats-number">284.5K</p>
                <p class="stats-label">Users</p>
            </div>
            <div class="stats-card">
                <p class="stats-number">3.6B</p>
                <p class="stats-label">Visits</p>
            </div>
        </div>

        <div class="feature-indicators">
            <div class="indicator-item"><span class="dot"></span> Fast short links</div>
            <div class="indicator-item"><span class="dot"></span> Google sharing ready</div>
            <div class="indicator-item"><span class="dot"></span> Clear click totals</div>
        </div>
